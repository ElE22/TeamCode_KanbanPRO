 ...
 * - Fechas por defecto (hoy y +2 semanas)
 * - Mejor organización visual
 * - Método limpiarCampos() implementado
 * 
 * @author salaz
 */
public class CrearSprintView extends JFrame {
     ...
     * - Fecha inicio: Hoy
     * - Fecha fin: Hoy + 14 días (2 semanas típicas de un sprint)
     */
     ...
     * @param placeholder El texto de placeholder
     */
    ...
    /**
     * Establece el título de la ventana con el nombre del proyecto
